...
ZEND_VM_HANDLER(184, ZEND_FETCH_SLICE_R, CONST|TMPVAR|CV, CONST|TMPVAR|CV)
{
	USE_OPLINE
	ZEND_VM_NEXT_OPCODE();
}

ZEND_VM_HANDLER(185, ZEND_FETCH_SLICE_W, VAR|CV, CONST|TMPVAR|UNUSED|NEXT|CV)
{
	USE_OPLINE
	ZEND_VM_NEXT_OPCODE();
}

ZEND_VM_HANDLER(186, ZEND_FETCH_SLICE_RW, VAR|CV, CONST|TMPVAR|UNUSED|NEXT|CV)
{
	USE_OPLINE
	ZEND_VM_NEXT_OPCODE();
}

ZEND_VM_HANDLER(187, ZEND_FETCH_SLICE_IS, CONST|TMPVAR|CV, CONST|TMPVAR|CV)
{
	USE_OPLINE
	ZEND_VM_NEXT_OPCODE();
}

ZEND_VM_HANDLER(188, ZEND_FETCH_SLICE_FUNC_ARG, CONST|TMP|VAR|CV, CONST|TMPVAR|UNUSED|NEXT|CV, NUM)
{
	USE_OPLINE
	ZEND_VM_NEXT_OPCODE();
}

ZEND_VM_HANDLER(189, ZEND_FETCH_SLICE_UNSET, VAR|CV, CONST|TMPVAR|CV)
{
	USE_OPLINE
	ZEND_VM_NEXT_OPCODE();
}

ZEND_VM_HANDLER(190, ZEND_ASSIGN_SLICE, VAR|CV, CONST|TMPVAR|UNUSED|NEXT|CV)
{
	USE_OPLINE
	ZEND_VM_NEXT_OPCODE();
}

ZEND_VM_HANDLER(191, ZEND_UNSET_SLICE, VAR|UNUSED|THIS|CV, CONST|TMPVAR|CV)
{
	USE_OPLINE
	ZEND_VM_NEXT_OPCODE();
}
